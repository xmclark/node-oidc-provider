...
export const DRAFTS = new Map(Object.entries({
  ...
  mTLS: {
    ...
    version: ['15-rc.1', 16, 17, 'draft-17'],
  },
  dPoP: {
    ...
    version: ['id-03', 'individual-draft-03'],
  },
  frontchannelLogout: {
  ...
  pushedAuthorizationRequests: {
    name: 'OAuth 2.0 Pushed Authorization Requests - draft 00',
    type: 'IETF OAuth Working Group draft',
    url: 'https://tools.ietf.org/html/draft-ietf-oauth-par-00',
    version: [0, 'individual-draft-01', 'draft-00'],
  },
  resourceIndicators: {
  ...
  secp256k1: {
    ...
    url: 'https://tools.ietf.org/html/draft-ietf-cose-webauthn-algorithms-04',
    version: ['draft-03', 'draft-04'],
  },
  sessionManagement: {
