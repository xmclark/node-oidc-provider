...
const DEFAULTS = {
  ...
  features: {
     ...
     * proof-of-possession mechanism on the application level. Example browser DPoP Token generation
     * [here](https://gist.github.com/panva/555a29644eed956ca73831b19fa06a6f).
     */
     ...
     *
     * title: [draft-ietf-oauth-access-token-jwt-03](https://tools.ietf.org/html/draft-ietf-oauth-access-token-jwt-03) - JSON Web Token (JWT) Profile for OAuth 2.0 Access Tokens
     *
     ...
     *
     * title: [draft-ietf-oauth-par-00](https://tools.ietf.org/html/draft-ietf-oauth-par-00) - OAuth 2.0 Pushed Authorization Requests
     *
     * description: Enables the use `pushed_authorization_request_endpoint` defined by the Pushed
     ...
     * features.secp256k1
     *
     * title: [html/draft-ietf-cose-webauthn-algorithms-04](https://tools.ietf.org/html/html/draft-ietf-cose-webauthn-algorithms-04) - Support for secp256k1 EC curve
     *
     * description: Enables the use of ES256K algorithm in `whitelistedJWA` configuration as well as
     *   having an EC JWK with secp256k1 curve in the provider keystore.
     */
    secp256k1: {
      enabled: false,
    },
